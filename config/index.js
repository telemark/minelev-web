...
module.exports = {
  ...
  TJOMMI_JWT_SECRET: process.env.TJOMMI_JWT_SECRET || 'Louie Louie, oh no, I got to go Louie Louie, oh no, I got to go',
  ...
  MESSAGE_QUEUE_CONNECTION_STRING: process.env.MESSAGE_QUEUE_CONNECTION_STRING,
